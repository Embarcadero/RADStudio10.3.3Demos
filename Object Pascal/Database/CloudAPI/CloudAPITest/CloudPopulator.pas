...
begin
  try
    case FStorageService.GetBucketLocation(BucketName) of
      amzrNotSpecified: Response := 'US Standard';
      amzrEUWest1: Response := 'EU (Ireland)';
      amzrEUWest2: Response := 'EU (London)';
      amzrEUWest3: Response := 'EU (Paris)';
      amzrEUCentral1: Response := 'EU (Frankfurt)';
      amzrUSEast1: Response := 'US Standard';
      amzrUSWest1: Response := 'US West (N. California)';
      amzrUSWest2: Response := 'US West (Oregon)';
      amzrAPSoutheast1: Response := 'Asia Pacific (Singapore)';
      amzrAPSoutheast2: Response := 'Asia Pacific (Sydney)';
      amzrAPNortheast1: Response := 'Asia Pacific (Tokyo)';
      amzrAPNortheast2: Response := 'Asia Pacific (Seoul)';
      amzrAPNortheast3: Response := 'Asia Pacific (Osaka-Local)';
      amzrSAEast1: Response := 'South America (Sao Paulo)';
      amzrUSClassic: Response := 'US Standard';
      amzrEU: Response := 'EU (Ireland)';
      amzrCNNorth1: Response := 'China (Beijing)';
      amzrCNNorthwest1: Response := 'China (Ningxia)';
    end;
